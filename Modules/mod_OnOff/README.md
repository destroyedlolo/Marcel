...
Sections are controlled through the topic `%ClientID%/OnOff/<Section identifier>`. 
...
Named Notification are controlled through the topic `%ClientID%/NamedNotifOnOff/<Named Notification identifier>`. 
